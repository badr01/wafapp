'use strict';
var loading = false;
var myApp = angular.module('WafApp', [
    'angular-growl',
    'ngResource',
    'ngTagsInput',
    'ui.bootstrap',
...
//Status controller
myApp.controller('EtatCtrl', function ($scope, Status, growl) {
  $scope.status = {
    output: '',
    nginxStatus: false,
    haproxyStatus: false
...
myApp.controller('paginationCtrl', [
  ...
  function ($scope, Access) {
    ...
    $scope.predicates = [
      ...
      {
        key: 'Filtrer par X_Forwarded_For',
...
'use strict';
//settings controller
myApp.controller('SettingsController', function ($scope, Settings, growl, $modal, $timeout) {
  //loading settings
  Settings.get(function (data) {
    $scope.options = data;
  });
